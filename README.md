...
Te damos la bienvenida a la **plataforma de laboratorios** del curso **IA generativa en Ciberseguridad**. Aquí podrás explorar diferentes tecnologías a través de prácticas guiadas. ¡Desarrolla tus habilidades y lleva tus conocimientos al siguiente nivel!
...
### [Práctica 2. Crea un flujo en LangSmith para analizar registros de seguridad](Capitulo05/Lab2.md)
...
### [Práctica 4. Prueba diferentes técnicas de ing de prompts para mitigar amenazas](Capitulo07/Lab4.md)

  - **Descripción**: En esta práctica, los participantes diseñarán e implementarán mensajes de sistema orientados a restringir el comportamiento de modelos de lenguaje frente a solicitudes maliciosas. Asimismo, pondrán a prueba distintas técnicas de ataque mediante prompts adversariales y reforzarán las medidas de protección para garantizar que la información sensible permanezca protegida ante intentos de manipulación.

  - ⏱️**Duración estimada**: 15 min.



### [Práctica 5. Explora las capacidades de Copilot en Microsoft Purview](Capitulo09/Lab5.md)
